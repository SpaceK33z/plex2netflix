...
module.exports = function (media) {
    return new Promise(function (resolve, reject) {
        ...
        if (media.imdb) {
            return got('https://netflixroulette.net/api/v2/usa/imdb/', { query: { imdbId: media.imdb }, json: true }).then(function (response) {
        ...
        return got('https://netflixroulette.net/api/v2/usa/search/', { query: { phrase: media.title, year: media.year }, json: true }).then(function (response) {
